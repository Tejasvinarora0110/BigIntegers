...
int main()
{
    ...
    int n1 = -321;
    long long int n2 = -9876543219876543;
    string str = "-92823573220181727383937444789373";
    BigInt f = to_Big(num1);                              //converting int to BigInt
    BigInt g = to_Big(num2);                              //converting long long int to BigInt
    BigInt h = to_Big(str1);                              //converting string to BigInt
